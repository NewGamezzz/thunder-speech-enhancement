    ...
    def __init__(
        ...
        **ignored_kwargs,
        ...
        if format == "default":
            ...
            self.clean_files = sorted(glob(join(data_dir, subset) + "/clean/*.npy"))
            self.noisy_files = sorted(glob(join(data_dir, subset) + "/noisy/*.npy"))
        else:
...
class SpecsDataModule(pl.LightningDataModule):
    ...
    def add_argparse_args(parser):
        ...
        parser.add_argument(
            "--hop_length", type=int, default=128, help="Window hop length. 128 by default."
        )
        parser.add_argument(
            "--num_frames",
            type=int,
        ...
        parser.add_argument(
            "--dummy", action="store_true", help="Use reduced dummy dataset for prototyping."
        )
        parser.add_argument(
            "--spec_factor",
            type=float,
